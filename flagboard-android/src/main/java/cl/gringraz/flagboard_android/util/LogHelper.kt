...
internal val unknownStateMessage by lazy { "is in a inconsistent state. Use the FlagBoard.init(@NonNull featureFlagsMap: Map<String, Any>) function." }
internal val initializedStateMessage by lazy { "is initialized." }
internal val initializingStateMessage by lazy { "is initializing." }
internal val tryToSaveUnsupportedTypeMsg by lazy { "try to save an unsupported data type" }
